...
export const developerPermissionCatalog = [
  ...
  { code: 'can_edit_owned_marketing_assets', description: 'Upload or delete Media Kit assets for a game belonging to the current user or team.' },
  ...
  { code: 'can_read_owned_marketing_assets', description: 'Read and download Media Kit assets for a game belonging to the current user or team.' },
